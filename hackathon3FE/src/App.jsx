  ...
  return (
    <BrowserRouter>
      <div className="app-outer min-h-screen flex items-center justify-center bg-gray-50 md:bg-gray-900">
        <div className="app-frame no-scrollbar flex flex-col w-full md:w-[420px] max-w-full h-auto md:h-[844px] bg-white text-gray-800 md:shadow-2xl md:rounded-2xl overflow-hidden md:border md:border-white/5">
          <Header />
